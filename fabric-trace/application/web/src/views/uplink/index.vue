    ...
    <div>
      <el-form ref="form" :model="tracedata" label-width="80px" size="mini" style="">
        ...
        <div v-show="userType=='经销商'">
          ...
          <el-form-item label="经销商名称与地址:" style="width: 300px" label-width="120px">
        ...
        <div v-show="userType=='零售商'">
          ...
          <el-form-item label="零售商名称:" style="width: 300px" label-width="120px">
            <el-input v-model="tracedata.Shop_input.Sh_shopName" />
          </el-form-item>
          <el-form-item label="零售商位置:" style="width: 300px" label-width="120px">
            <el-input v-model="tracedata.Shop_input.Sh_shopAddress" />
          </el-form-item>
          <el-form-item label="零售商电话:" style="width: 300px" label-width="120px">
